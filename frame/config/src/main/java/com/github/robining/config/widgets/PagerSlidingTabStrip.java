...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip setTabSelectedTextColor(int tabSelectedTextColor) {
        this.tabSelectedTextColor = tabSelectedTextColor;
        return this;
    }

    public int getTabUnselectedTextColor() {
        return tabUnselectedTextColor;
    }

    public PagerSlidingTabStrip setTabUnselectedTextColor(int tabUnselectedTextColor) {
